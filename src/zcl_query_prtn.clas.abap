CLASS zcl_query_prtn DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_query_prtn IMPLEMENTATION.
...
TRY.
 ...
 TRY.
    ...
    DATA(lo_request) = lo_client_proxy->create_resource_for_entity_set('ZTST_C_PARTNER')->create_request_for_read( ).
